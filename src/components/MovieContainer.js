            ...
            {movie.poster_path ? (
                <Image 
                    ...
                    />
                        ...
                        <div className='poster' style={{width:'300px',height:'450px',fontSize:'30px',fontWeight:'bold',lineHeight:'450px',background:'-webkit-gradient(linear,left top,left bottom,from(#666),to(#ccc)'}}>No Poster Available</div>
                        )
                    }
